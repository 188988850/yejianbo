...
<li class="" onclick="activeselect(this)"><a href="./user/upgrade.php" pjax="no"><i class="layui-icon layui-icon-website"></i> 网站搭建</a></li>
...
<a class="layui-btn layui-btn-danger" href="./user/upgrade.php"><i class="layui-icon layui-icon-website"></i> 注册分站</a>
</div>
</center>
