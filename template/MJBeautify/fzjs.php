...
$count1=$DB->getColumn("SELECT count(*) from shua_site");
$count2=$DB->getColumn("SELECT count(*) from shua_site where addtime>='$thtime'");
?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel-shadow panel-bor-top rdu-5x">
	...
	<div class="text-kuang" style="line-height:20px;">
		...
		<center>
		<a class="btn btn-info btn-sm tw1" style="margin-right:30%" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq']?>&site=qq&menu=yes" target="_blank">咨询客服</a><a class="btn btn-info btn-sm tw1" href="./user/upgrade.php">搭建分站</a>
		</center>
		<hr>
