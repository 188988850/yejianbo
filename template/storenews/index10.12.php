...
<div id="body">
    ...
    <div class="fui-page-group " style="height: auto">
        <div class="fui-page  fui-page-current " style="height:auto; overflow: inherit">
                    ...
                    <form action="" method="get" id="goods_search"><input type="hidden" value="yes" name="search">
                        <div class="fui-searchbar bar"
                            ...
                            <div class="searchbar center searchbar-active" style="height: 2.5rem" >
                                ...
                                <button type="submit"  class="searchbar-cancel searchbtn  " style="width:3.5rem;background-color:#<?php echo $conf['rgb01']; ?>;height: 1.65rem; border-radius:0 50px 50px  0;color: #fff;"><a style="color: #f6f6f6;font-size: 14px;">搜索</a></button>
            ...
            <?php if($conf['appurl']){?>
                <a style="position:fixed;right:10px;bottom:18%; z-index:10;" href="<?php echo $conf['appurl']; ?>">
...
<!-- <a style="position:fixed;right:10px;bottom:17%; z-index:10; " href="/?mod=time">
            ...
            <?php if(checkmobile()){ ?>
                    <div style="width:100%;background-color:#ffffff;padding: 0rem 0.6rem; padding-top: 0.3rem; overflow: hidden;  font-size: 0.7rem; font-weight: bold; display:flex; align-content: center; justify-content: space-between" >
                        <a href="/user/upgrade.php" style="width: 23%;height: 4rem;border-radius:8px;position: relative;background: rgba(255, 232 , 187, 0.3);overflow: hidden" >
                        ...
                        <a href="/?mod=time" style="width: 23%;height: 4rem;border-radius:8px;position: relative;background: rgba(183 , 230  , 253, 0.3);overflow: hidden" >
                            <div style="position: absolute;top: 13%;left: 5%;z-index: 10">
                    ...
                    <div style="width:100%;background-color:#ffffff;padding: 0rem 0.6rem; padding-top: 0.3rem; overflow: hidden;  font-size: 0.7rem; font-weight: bold; display:flex; align-content: center; justify-content: space-between" >
                        <a href="/?mod=choujiang" style="width: 49%;height: 4rem;border-radius:8px;position: relative;background: rgba(255, 232 , 187, 0.3);overflow: hidden" >
                            <div style="position: absolute;top: 20%;left: 5%;z-index: 10">
                                <li style="color: #666666;font-size: 0.7rem;font-weight:600;">在线抽奖</li>
               ...
               <?php }else{ ?>
                    <div style="width:100%;background-color:#ffffff;padding: 0rem 0.6rem; padding-top: 0.3rem; overflow: hidden;  font-size: 0.7rem; font-weight: bold; display:flex; align-content: center; justify-content: space-between" >
                        <a href="/user/upgrade.php" style="width: 23%;height: 3.5rem;border-radius:8px;position: relative;background: rgba(255, 232 , 187, 0.3);overflow: hidden" >
                            <div style="position: absolute;top: 13%;left: 5%;z-index: 10">
                        ...
                        <a href="/?mod=time" style="width: 23%;height: 3.5rem;border-radius:8px;position: relative;background: rgba(183 , 230  , 253, 0.3);overflow: hidden" >
                            <div style="position: absolute;top: 13%;left: 5%;z-index: 10">
                                <li style="color: #ec7276;font-size: 0.55rem;font-weight:600;">每日更新</li>
                                <li style="color: #ec7276;font-size: 0.35rem;font-weight:0;line-height: 0.9rem;font\-weight:lighter">只为提供最好的</li>
                            </div>
                    ...
                    <div style="width:100%;background-color:#ffffff;padding: 0rem 0.6rem; padding-top: 0.3rem; overflow: hidden;  font-size: 0.7rem; font-weight: bold; display:flex; align-content: center; justify-content: space-between" >
                        <a href="/?mod=choujiang" style="width: 49%;height: 3.5rem;border-radius:8px;position: relative;background: rgba(255, 232 , 187, 0.3);overflow: hidden" >
                            <div style="position: absolute;top: 20%;left: 5%;z-index: 10">
                                <li style="color: #666666;font-size: 0.6rem;font-weight:600;">在线抽奖</li>
                                <span style="font-size: 0.45rem;background: #f6d885;color:#995621; padding: 0rem 0.4rem;width: 100%;border-radius: 0.2rem;font\-weight:lighter">立即进入 ></span>
                            </div>
                            <img style="width:100%;height: 100%; position: absolute;top: 0;left: 0;" src="https://tp01-1302784280.cos.ap-nanjing.myqcloud.com/image/shouye/list05.png">
                        </a>
