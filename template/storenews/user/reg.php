...
<body>
    ...
    <div class="stitle">注册</div>
    <div class="sinput"><i class="fa fa-user" style="color: #<?php echo $conf['rgb01']; ?>;width:10%"></i><input type="text" name="user" value="" style="font-size: 14px;" required="required" placeholder="请输入登录账号"/></div>
    <div class="sinput"><i class="fa fa-key" style="color: #<?php echo $conf['rgb01']; ?>;width:10%"></i><input type="password" name="pwd" class="" style="font-size: 14px;" required="required" placeholder="请输入登录密码"/></div>
    
    <div class="sinput"><i class="fa fa-qq" style="color: #<?php echo $conf['rgb01']; ?>;width:10%"></i><input type="text" name="qq" value="" style="font-size: 14px;" required="required" placeholder="输入QQ号，用于找回密码"/></div>
    
    <div class="sinput" style="position: relative;"><i class="fa fa-exclamation-triangle" style="color: #<?php echo $conf['rgb01']; ?>;width:10%"></i> <input  type="text" name="code" value="" class="account-group-input-code" required="required" style="font-size: 14px;" placeholder="请输入验证码"/>
        <img id="codeimg" src="./code.php?r=<?php echo time();?>" height="45" style="font-size: 14px;" onclick="this.src='./code.php?r='+Math.random();" title="点击更换验证码">
    </div>
                                
    <div class="loginbtn" id="submit_reg">注册</div>
    <a href="login.php"><div class="loginbtn1">已有账号，返回登录</div></a>
