            ...
            <div class="fui-content navbar" id="container" style="background-color: #fafafc;overflow: inherit">
                <div class="default-items">
                    ...
                    <div style="width:100%;background-color:#ffffff;padding: 0rem 0.6rem; padding-top: 0.3rem; overflow: hidden;  font-size: 0.7rem; font-weight: bold; display:flex; align-content: center; justify-content: space-between" >
                        <a href="/user/upgrade.php" style="width: 49%;height: 3.4rem;border-radius:8px;position: relative;background: rgba(255, 232 , 187, 0.3);overflow: hidden" >
                    ...
                    <div class="miaosha" onclick="javascrtpt:window.location.href='/user/upgrade.php'" style="width: 100%;
    margin: 0px auto;
    position: relative;
...
$numrows1=$DB->getColumn("SELECT count(*) FROM shua_tools WHERE addtime>='$thtime'");
$numrows2=$DB->getColumn("SELECT count(*) FROM shua_tools WHERE addtime<='$thtime' AND addtime>'$yesterday_time'");
?>
