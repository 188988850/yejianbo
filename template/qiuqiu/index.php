...
<div id="bds">
 ...
 <div class="alert-danger"><center>&nbsp搭建和本站一模一样的网站！<a href="./?mod=fzjs" class="btn btn-info btn-xs">了解分站</a> <a target="_blank" href="./user/upgrade.php" class="btn btn-danger btn-xs">  点击搭建</a></center></div>
...
<div class="tab-pane fade in" id="admin">
		<div class="alert alert-info">本站支持搭建分站，分站仅需8.88元，全自动自助搭建！<a target="_blank" href="./?mod=fzjs" class="btn btn-info btn-xs">了解分站</a> <a target="_blank" href="./user/upgrade.php" class="btn btn-danger btn-xs">  点击搭建</a>
		</div>
