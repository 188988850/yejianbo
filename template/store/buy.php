...
function closetc(){
  ...
  <div class="content_friends">
            ...
            <img src="./assets/img/logo_22332.png" /> 立即升级站长享更低价下单！<a class="label label-danger fa fa-hand-o-right" <a="" href="user/upgrade.php"> 点击进入</a>
            <?php }?>
            <?php  if( $userrow['power']==1){?>
            <img src="./assets/img/logo_22332.png" /> 立即升合伙人享更低价下单！<a class="label label-danger fa fa-hand-o-right" <a="" href="user/upgrade.php"> 点击进入</a>
            <?php }?>
