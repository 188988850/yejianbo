...
$total = $DB->getColumn("SELECT count(*) FROM `shua_orders` A WHERE{$sql} ");
...
<div class="layui-card qt-card">
              <div class="layui-card-header" style="margin-top: -0.2rem;background: #f7f7f8;border-radius: 10px;font-size: 0.8em;">
               <p style="width: 99%" class="layui-elip"><?php echo $row['name']?></p>
                       ...
                       <div class="layui-col-xs8"  border="10px" style="margin-top: .3rem;background: #f7f7f8;border-radius: 10px;font-size: 0.8em;">
