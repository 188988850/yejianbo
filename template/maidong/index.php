		...
		<div id="sidebar-scroll">
			<div class="sidebar-content">
				<ul class="sidebar-nav">
					...
					<?php if($conf['fenzhan_buy']==1){?>
					<li><a href="./user/upgrade.php">　<i class="fa fa-star sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">开通分站</span></a></li>
					<?php }?>
            ...
            <tbody>
                ...
                <tr class="active">
                    <td>
                        ...
                        <a href="user/upgrade.php" target="_blank" class="btn btn-effect-ripple  btn-danger" style="overflow: hidden; position: relative;"><span class="btn-ripple animate" style="height: 98px; width: 98px; top: -33.1px; left: 16px;"></span><i class="fa fa-arrow-right"></i> 马上开通</a>
