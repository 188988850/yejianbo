            ...
            <tbody>
                ...
                <tr class="active">
                    <td>
                        ...
                        <a href="user/upgrade.php" target="_blank" class="btn btn-effect-ripple  btn-danger" style="overflow: hidden; position: relative;"><i class="fa fa-arrow-right"></i> 马上开通</a>
                    </td>
                </tr>
            </tbody>
        </table>
