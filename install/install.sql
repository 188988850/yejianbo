...
INSERT INTO `shua_config` VALUES ('version', '2055');
...
INSERT INTO `shua_config` VALUES ('cdnpublic', '0');
INSERT INTO `shua_config` VALUES ('sitename', '彩虹云商城');
INSERT INTO `shua_config` VALUES ('keywords', 'QQ云商城,自助下单,网红助手,网红速成');
INSERT INTO `shua_config` VALUES ('description', '彩虹云商城，专注数字娱乐产品、网络生活服务产品销售，只为您方便、快捷、省心！');
...
INSERT INTO `shua_config` VALUES ('paymsg', '<hr/>小提示：<b style="color:red">如果微信出现无法付款时，您可以把微信的钱转到QQ里，然后使用QQ钱包支付！<a href="./?mod=wx" target="_blank">点击查看教程</a></b>');
INSERT INTO `shua_config` VALUES ('modal', '');
INSERT INTO `shua_config` VALUES ('bottom', '');
INSERT INTO `shua_config` VALUES ('gg_search', '<span class="label label-primary">待处理</span> 说明正在努力提交到服务器！<p></p><p></p><span class="label label-success">已完成</span> 已经提交到接口正在处理！<p></p><p></p><span class="label label-warning">处理中</span> 已经开始为您开单 请耐心等！<p></p><p></p><span class="label label-danger">有异常</span> 下单信息有误 联系客服处理！');
...
INSERT INTO `shua_config` VALUES ('fenzhan_pricelimit', '1');
INSERT INTO `shua_config` VALUES ('fenzhan_kfqq', '1');
INSERT INTO `shua_config` VALUES ('tixian_rate', '98');
...
INSERT INTO `shua_config` VALUES ('faka_mail', '<b>商品名称：</b> [name]<br/><b>购买时间：</b>[date]<br/><b>以下是你的卡密信息：</b><br/>[kmdata]<br/>----------<br/><b>使用说明：</b><br/>[alert]<br/>----------<br/>云商城自助下单平台<br/>[domain]');
...
INSERT INTO `shua_config` VALUES ('tixian_limit', '1');
INSERT INTO `shua_config` VALUES ('workorder_open', '1');
INSERT INTO `shua_config` VALUES ('workorder_type', '业务补单|卡密错误|充值没到账|订单中途改了密码');
INSERT INTO `shua_config` VALUES ('invite_content', '特价名片赞0.1元起，免费领名片赞，空间人气、QQ钻、大会员、名片赞、说说赞、空间访问、全民K歌，链接：[url] (请复制链接到浏览器打开)');
INSERT INTO `shua_config` VALUES ('fenzhan_edithtml', '1');
INSERT INTO `shua_config` VALUES ('shopdesc_editor', '1');
INSERT INTO `shua_config` VALUES ('updatestatus', '0');
INSERT INTO `shua_config` VALUES ('updatestatus_interval', '6');
