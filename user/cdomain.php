...
if($_GET['act']=='submit'){
	...
	$DB->exec("UPDATE `shua_site` SET `domain`=:domain,`rmb`=`rmb`-:rmb WHERE `zid`=:zid", [':domain'=>$domain, ':rmb'=>$price, ':zid'=>$userrow['zid']]);
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 80px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>更换域名</span></a>
        ...
        <form action="./cdomain.php?act=submit" method="post" role="form">
            ...
            <div class="block-white" >
                <div class="form-group form-group-transparent form-group-border-bottom">
                    <div class="input-group" style="width:100%">
                        ...
                        <input name="domain" class="form-control" style="text-align: right" value="<?php echo $userrow['domain']?>" disabled="">
                    </div>
                </div>
            </div>
            ...
            <div class="text-center" style="padding: 20px 0;">
                <input type="submit" name="submit" class="btn submit_btn" style="width: 70%;padding:5px;" value=" <?php echo $price?>元 更换域名">
            </div>
        </form>
