...
?>
  ...
  <form action="./fufeiqun.php?my=edit_submit&id=<?php echo $id ?>" method="POST"  onsubmit="return checkinput()">
    ...
    opacity: .8;align-items: center;justify-content: space-between;display: flex; flex-direction: row;height: 30px;">
                <a href="fufeiqun.php"  class="font-weight display-row align-center" style="height: 1.6rem;line-height: 1.65rem;width: 50%">
...
<div class="main-content1">
   <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>编辑群聊资料</span></a>
            ...
            <div class="form-group form-group-transparent form-group-border-bottom">
                 ...
                 <input type="text" class="form-control" id="picurl" name="ename7" value="<?php echo $row['ename7']; ?>" style="visibility: hidden;" readonly onclick="fileView()">
           ...
           <div class="form-group form-group-transparent form-group-border-bottom">
            ...
            <div class="form-group form-group-transparent form-group-border-bottom">
                <div class="input-group" style="width:100%">
                    ...
                    <input type="text" class="form-control"  name="money" value="<?php echo $row['money']; ?>" required="" placeholder="请输入入群费用">
                </div>
            </div>
              ...
              <div class="form-group form-group-transparent form-group-border-bottom">
                <div class="input-group" style="width:100%">
                    ...
                    <input type="text" class="form-control"  name="weixing" value="<?php echo $row['weixing']; ?>" required="" placeholder="请输入微信号">
                </div>
            </div>
             ...
             <div class="form-group form-group-transparent form-group-border-bottom">
                <div class="input-group" style="width:100%">
                    ...
                    <input type="text" class="form-control"  name="ename10" value="<?php echo $row['ename10']; ?>" required="" placeholder="">
                </div>
            </div>
   ...
   <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    <img src="../assets/img/icon/dingdan.png" style="width: 20px; margin-right: 10px;">
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>编辑群聊内容</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    </div>
                    <div class="content-item-bottom">
             ...
             <div class="form-group form-group-transparent form-group-border-bottom">
                <div class="input-group" style="width:100%">
                    ...
                    <input type="text" class="form-control"  name="ename1" value="<?php echo $row['ename1']; ?>" required="" placeholder="请输入第一标题">
                </div>
            </div>
      ...
      <div class="form-group form-group-transparent">
      <div align="center"><div style="width: 95%;"><textarea class="form-control" placeholder=" 请输入第一标题内容" name="ename2" style="width:100%;height:80px"><?php echo $row['ename2'];?></textarea>
       </div>
     </div>
          <div class="form-group form-group-transparent form-group-border-bottom"></div>
             ...
             <div class="form-group form-group-transparent form-group-border-bottom">
                <div class="input-group" style="width:100%">
                    ...
                    <input type="text" class="form-control"  name="ename3" value="<?php echo $row['ename3']; ?>" required="" placeholder="请输入第二标题">
                </div>
            </div>
      ...
      <div class="form-group form-group-transparent">
      <div align="center"><div style="width: 95%;"><textarea class="form-control" placeholder=" 请输入第二标题内容" name="ename4" style="width:100%;height:80px"><?php echo $row['ename4'];?></textarea>
       </div>
     </div>
          <div class="form-group form-group-transparent form-group-border-bottom"></div>
      ...
      <div class="form-group form-group-transparent form-group-border-bottom">
            ...
            <div class="form-group form-group-transparent">
             ...
             <div class="form-group form-group-transparent">
      <div align="center"><div style="width: 95%;"><textarea class="form-control" placeholder=" 请输入评论比内容" name="ename8" style="width:100%;height:80px" class="form-control form-control-left"><?php echo $row['ename8']; ?></textarea>
       </div>
     </div>
          <div class="form-group form-group-transparent form-group-border-bottom"></div>
...
{
$id=$_GET['id'];
$rows=$DB->getRow("select * from shua_sscc where id='$id' limit 1");
if(!$rows)
	showmsg('当前记录不存在！',3);
...
if($name==NULL or $ename==NULL){
    ...
    $update_query = "UPDATE `shua_sscc` SET `name`='$name',`ename`='$ename',`money`='$money',`ename1`='$ename1',`ename2`='$ename2',`ename3`='$ename3',`ename4`='$ename4',`ename5`='$ename5',`ename6`='$ename6',`ename7`='$ename7',`ename8`='$ename8',`ename9`='$ename9',`weixing`='$weixing',`ename10`='$ename10' WHERE `id`='$id'";
...
{
    $id = $_GET['id'];   
    if($DB->exec("DELETE FROM shua_sscc WHERE id='{$id}'"))
    {
        showmsg('删除成功！', 1);
    }
    else
...
<div class="main-content1">
   <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    <img src="../assets/img/icon/qunliao.png" style="width: 20px; margin-right: 10px;">
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>群聊管理</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span>当前共<?php echo ''.$numrows.'' ?>个群聊</span></a>
                    </div>
<div style="display: flex; justify-content: center; align-items: center;">  
    <div class="fz-view" style="padding: 0 10px; margin-right: 1px;">  
        <a class="fz-detail" style="width: 100%; height: 5rem; border-radius: 5px; text-align: center;" href="./uupx.php?my=add">  
            <div class="fz-info display-row align-center justify-center"  
                 style="background-image: linear-gradient(to right, rgba(252, 198, 108, 1), rgba(249, 138, 63, 1)); border-radius: 5px; width: 100%;">  
                
                <font style="font-size: 15px;" color="#FFFFFF">发布群聊</font>  
            </div>  
        </a>  
    </div>  
  
    <div class="fz-view" style="padding: 0 10px;">  
        <a class="fz-detail" style="width: 100%; height: 5rem; border-radius: 5px; text-align: center;" href="http://<?php echo $userrow['domain']?>/?mod=weixin">  
            <div class="fz-info display-row align-center justify-center"  
                 style="background-image: linear-gradient(to right, rgba(0, 123, 255, 1), rgba(0, 191, 255, 1)); border-radius: 5px; width: 100%;">  
                
                <font style="font-size: 15px;" color="#FFFFFF">群聊列表</font>  
            </div>  
        </a>  
    </div>  
</div>
...
if ($rs->rowCount() == 0) {
    ...
    <div style='display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;'>
        <div class='content-item'><div align='center' style='padding: 15px;'><a style='color:#666666;font-size: 13px;'>您当前没有发布群聊<br>赶快发布一个试试吧</a>
                   </div>
</div></div></div>";
} else {
    while ($res = $rs->fetch()) {
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <img src="../assets/img/icon/jinxing.png" style="width: 15%; margin-right: 20%;">
                    <a style="font-weight: 600; font-size: 12px; margin-right: 8px;"><span></span></a>
                    <div class="charge-bkk2"><a href="http://'.$hhs.'/?mod=cce&id='.$res['id'].'" style="color: #fff;">查看</a></div>&nbsp;
                    <div class="charge-bkk1"><a href="./fufeiqun.php?my=edit&id='.$res['id'].'" style="color: #fff;">编辑</a></div>&nbsp;&nbsp;
                    <div class="charge-bkk3"><a href="javascript:void(0);" onclick="if(confirm(\'您确定要删除吗？\')){ window.location = \'./fufeiqun.php?my=ediu&id='.$res['id'].' \';}" style="color: #fff;">删除</a></div></div>
                    <div class="content-item-bottom1">
                <div style="padding: 0px 0;font-size: 1.3rem;color: #858585;">
                    <font color="#000">群聊名称：'.$res['name'].'<br></font>
                    <font color="#000">进群金额：'.$res['money'].'元<br></font>
                    <font color="#000">订单总数：'.(isset($res['gg']) && $res['gg']!= ''? $res['gg'] : 0).'个<br></font>
                    <font color="#000">发布时间：'.$res['addtime'].'<br></font>
                    <font color="#000">群聊二维码：<a href="../'.$res['ename9'].'" target="_blank">立即查看</a><br></font>
                    <font color="#000">获取推广码：<a href="./bsdf.php?id='.$res['id'].'">立即获取</a><br></font>
                </div>
                </div>
            </div>
        </div>
