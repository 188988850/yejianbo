...
.gdan_txt{height:3em;line-height:3em;text-indent:1em;font-weight:800;}
.gdan_txt>span{position:absolute;right:3em;}
.gdan_zhugan{width:96%;height:auto;padding-top:1em;margin-left:2%;padding-left:.5em;padding-right:1em;margin-bottom:1em;border-top:solid 0.1px #a9a9a9}
...
.gdan_srk{width:98%;height:8em;margin-left:1%;margin-top:1em;border-color:#6495ed;border-radius: 9px !important;}
.gdan_huifu1{width:6em;height:2.5em;border:none;background-color:#1e90ff;color:#fff;margin:.5em 0 .5em 1%;border-radius: 9px !important;}
...
.form-group-transparent2 {
    border-radius: 0;
    border: 0px solid transparent;
    padding: 4px 0;
    margin-bottom: 0px;
}
.form-group-border-bottom2 {
...
function display_status($status){
	if($status==1)
		return '<font color="" style="color: #cc4125;">此工单有新回复</font>';
	elseif($status==2)
		return '<font color="" style="color: #666666;">此工单已经结单</font>';
	else
		return '<font color="" style="color: #3c78d8;">等待客服回复</font>';
}
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 80px;">
        <div class="content-item">
            <div class="content-item-top">
                    <img src="../assets/img/icon/bianji.png" style="width: 20px; margin-right: 10px;">
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>编辑工单</span></a>
            ...
            <form action="./workorder.php?my=add_submit" method="POST">
                <div class="block-white" style="border-radius: 9px !important;padding:0 10px">
...
<?php }?>
                    ...
                    <div class="form-group form-group-transparent form-group-border-bottom">
                        ...
                        <div class="input-group" style="width:97%; solid #f2f2f2;line-height: 4rem ">
                            <input type="text" name="code" class="form-control"  style="height: 4rem" required="required"  placeholder="请填写验证码"/>
                    ...
                    <div class="form-group form-group-transparent2 form-group-border-bottom2">
                        </div>
                <div  style="font-size: 1.2rem;color: #999999;padding: 0 10px;margin-top: 10px">
                    提示:验证码一直出错？点击验证码可刷新更换。<br><br>
                    提示:找不到要提交的订单？<a href="../?mod=query">点击进入查询订单</a>，在订单详情页面点击【售后反馈】可以直接提交工单。<br><br>
                    说明:<font color="#ff0000">成功提交工单后，本站客服会在24小时内为您处理解答，请耐心等待勿催促。</font><br><br>
                    说明:0元免费购买的商品请勿提交售后反馈，客服无时间处理免费商品，感谢理解。
                </div>
...
<div class="col-xs-12 col-sm-10 col-md-6 col-lg-4 center-block " style="float: none; background-color:#fff;padding:0;max-width: 550px;">
    ...
    padding: 3px 7px;
    opacity: .8;align-items: center;justify-content: space-between;display: flex; flex-direction: row;height: 30px;">
                <a href="../?mod=duanju" class="font-weight display-row align-center" style="height: 1.6rem;line-height: 1.65rem;width: 50%">
                    <img style="height: 1.4rem" src="../assets/img/fanhui.png">&nbsp;
                </a>
                <div style="margin: 0px 8px; border-left: 1px solid rgb(214, 215, 217); height: 16px; border-top-color: rgb(214, 215, 217); border-right-color: rgb(214, 215, 217); border-bottom-color: rgb(214, 215, 217);"></div>
                <a href="../" class="font-weight display-row align-center" style="height: 1.6rem;line-height: 1.65rem;width: 50%">
...
<div class="main-content">
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 80px;">
        <div class="content-item">
            <div class="content-item-top">
                    <img src="../assets/img/icon/bianji.png" style="width: 20px; margin-right: 10px;">
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>短剧缺失反馈</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    </div>
            <form action="./workorder.php?my=add_submit2" method="POST">
                <div class="block-white" style="border-radius: 9px !important;padding:0 10px">
                    ...
                    <div class="form-group form-group-transparent form-group-border-bottom">
                        <div class="input-group" style="width:100%">
                            <textarea class="form-control" name="content" rows="5" placeholder="请填写短剧名称，如有多个，请按照1.某某某 2.某某某 3.某某某的格式进行提交反馈"
                                      required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-group-transparent form-group-border-bottom">
                        ...
                        <div class="input-group" style="width:97%; solid #f2f2f2;line-height: 4rem ">
                            <input type="text" name="code" class="form-control"  style="height: 4rem" required="required"  placeholder="请填写验证码"/>
                            <div class="input-group-addon" style="padding: 0">
                                <img id="codeimg" src="./code.php?r=<?php echo time();?>" style="height:4rem" onclick="this.src='./code.php?r='+Math.random();" title="点击更换验证码">
                            </div>
                ...
                <div  style="font-size: 1.2rem;color: #999999;padding: 0 10px;margin-top: 10px">
                     提示:验证码一直出错？点击验证码可刷新更换。<br><br>
                     说明:成功提交后，本站客服会在2小时内为您更新上传至平台，反馈时间请在早10:00~晚10:00进行，其它是休息时间不进行上传，反馈后请耐心等待勿催促。
                </div>
                <div class="text-center" style="padding: 30px 0;">
                    <input type="submit" class="btn submit_btn" style="width: 80%;padding:8px;" value="提交">
                </div>
...
<div class="main-content">
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 80px;">
        <div class="content-item">
            <div class="content-item-top">
                    <img src="../assets/img/icon/goutong.png" style="width: 20px; margin-right: 10px;">
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>沟通记录 - <?php echo count($contents)?>次</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    </div>
                	...
                	<div class="gdan_zhugan" style="border: none;">
                		...
                		<div class="gdan_kjia1">
                			<div class="gdan_xiaozhi">反馈信息</div>
                			<p>问题描述：<?php echo str_replace(array("\r\n", "\r", "\n"), "<br/>",htmlspecialchars($contents[0]))?></p>
                			<p>订单编号：<?php echo $rows['orderid']?$rows['orderid']:'无订单号';?></p>
                			<p>反馈时间：<span><?php echo $rows['addtime']?></span></p>
                ...
                for($i=1;$i<count($contents);$i++){
                	...
                	<div class="gdan_kjia1">
                	<div class="gdan_xiaozhi">'.($content[0]==1?'官方客服':$userrow['user']).'</div>
                	<div class="gdan_xiaozhi">回复时间：'.$content[1].'</div>
                	'.str_replace(array("\r\n", "\r", "\n"), "<br/>",htmlspecialchars($content[2])).'
                	<a  style="width: 100%;" href="javascript:;" id="copy-btn" data-clipboard-text="'.str_replace(array("\r\n", "\r", "\n"), "<br/>",htmlspecialchars($content[2])).'">
                ...
                if($rows['status']==0){
                ?>
                <div class="gdan_jied">请耐心等待客服处理</div></div> </div>
                    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
                        <div class="content-item1">
                    </div>
                </div>
                ...
                ?>
                <div class="gdan_jied">此工单已经结单</div></div> </div>
                    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
                        <div class="content-item1">
                    </div>
                </div>
...
$sql="INSERT INTO `pre_workorder` (`zid`,`type`,`orderid`,`content`,`picurl`,`addtime`,`status`) VALUES (:zid, :type, :orderid, :content, :picurl, NOW(), 0)";
$data = [':zid'=>$userrow['zid'], ':type'=>66, ':orderid'=>$orderid, ':content'=>$content, ':picurl'=>$picurl];
if($DB->exec($sql, $data)){
	$id = $DB->lastInsertId();
	if($conf['message_workorder']==1){
		\lib\MessageSend::workorder_new($id, $userrow['user'], $userrow['zid'], display_type(66), $content);
	}
	unset($_SESSION['vc_code']);
	showmsg('<div class="form-group form-group-transparent" style="background: #f2f2f2; padding:2px 0px;padding-left: 10px;margin: 0 -10px;">
                <div class="input-group" style="width:100%">
...
<div class="main-content">
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 80px;">
        <div class="content-item">
            <div class="content-item-top">
                    <img src="../assets/img/icon/fankui.png" style="width: 20px; margin-right: 10px;">
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>售后反馈</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    <div class="charge-btn"><a href="./workorder.php?my=add" style="color: #fff;">提交工单</a></div></div>
           <div style="padding: 10px 5px;color:#f5f5f5;font-size: 1.2rem" class="display-row align-center justify-between">
                ...
                <div style="padding: 0px 0;font-size: 1.3rem;color: #858585;">
                    <font color="#980000">亲爱的用户，您好！<br></font>
                    <font color="#000">如果您在使用本平台的过程中，遇到有关于产品售后相关的问题需要咨询或建议，首先，请您不要着急，您可以在本页面【提交工单】进行售后反馈。<br><br></font>
                    <font color="#980000">工单处理时间：<br></font>
                    <font color="#000">您所提交的售后工单，<font color="#ff0000">本站客服会在24小时内为您处理解答</font>，请耐心等待，并且及时关注工单状况，客服回复后，可点击工单旁边的【查看工单】按钮，查询工单回复状态。</font>
                </div>
            </div>
        </div>
    </div>
    ...
    echo '<div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 13px; margin-right: 8px;"><span>订单号:'.$res['orderid'].'</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    <div class="charge-btn"><a href="./workorder.php?my=view&id='.$res['id'].'" style="color: #fff;">查看工单</a></div></div>
                    <div class="content-item-bottom">
                <div style="padding: 0px 0;font-size: 1.3rem;color: #858585;">
                    <font color="#000">
                    工单类型：'.display_type($res['type']).'<br>
                    问题描述：<a href="./workorder.php?my=view&id='.$res['id'].'">'.htmlspecialchars($content).'</a><br>
                    工单状态：'.display_status($res['status']).'<br>
                    提交时间：'.$res['addtime'].'</font>
                </div>
            </div>
        </div>
    </div>';
