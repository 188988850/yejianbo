...
$numrows=$DB->getColumn("SELECT count(*) from shua_points WHERE zid='{$userrow['zid']}'{$sql}");
...
$rs=$DB->query("SELECT * FROM shua_points WHERE zid='{$userrow['zid']}'{$sql} order by id desc limit $offset,$pagesize");
while($res = $rs->fetch())
{
