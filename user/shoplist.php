...
while($res = $rs->fetch()){
    ...
    $select .= '<a id="tab_'.$res['cid'].'" href="./shoplist.php?cid='.$res['cid'].'&cidr='.$res['cid'].'" style="margin:5px 8px 5px 8px;width: 20%;height: 55px;align-items: center;justify-content: space-between;display: flex;flex-direction: column;">
                <div style="height: 30px;width: 30px;display: inline-block;overflow: hidden;position: relative;">
                    <div style="background-image: url(\'/assets/img/all.png\'); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;"></div>
...
<div class="col-xs-12 col-sm-10 col-md-6 col-lg-4 center-block " style="float: none; background-color:#fff;padding:0;max-width: 550px;">
    ...
    opacity: .8;align-items: center;justify-content: space-between;display: flex; flex-direction: row;height: 30px;">
            ...
            <a href="javascript:void(0)" onclick="auto_price(0)" style="font-size:1.3rem;" class="display-row align-center">
                ...
                <?php if($userrow['inbr']>='1' || $userrow['inbr2']>='1'){?>
...
<div class="main-content">
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 80px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>亲爱的站长，您好！</span></a>
                ...
                <div style="padding: 0px 0;font-size: 1.3rem;color: #858585;">
                    <font color="#980000">如何提升商品售价？<br></font>
                    <font color="#000">点击提升售价，选择百分比或者固定金额，输入数字整数，百分比输入10=提升10%售价，固定金额输入10=提升10元售价，商品售价不做上限要求，具体由您自己设定。<br><br></font>
                    <font color="#980000">修改价格之后首页价格没变化？<br></font>
                    <font color="#000">因为您当前的账号属于站长级别，看到的当然是您自己的价格，需要您退出当前登录的账号后首页才能看到您设定的售价，否则看到的都是系统成本价。</font>
                </div>
                </div>
            </div>
        </div>
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    <img src="../assets/img/icon/tiaojia.png" style="width: 20px; margin-right: 10px;">
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>商品调价设置</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    </div>
                    <div class="content-item-bottom">
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>编辑商品</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    <div class="charge-btn"><a href="javascript:history.back()" style="color: #fff;">返回</a></div></div>
                    <div class="content-item-bottom">
        <div class="form-group form-group-transparent" style="background: #f2f2f2; padding:8px 10px">
            ...
            <form action="./shoplist.php?my=edit_submit&tid=<?php echo $tid ?>>" method="POST">
                ...
                <div class="text-center" style="padding: 15px 10px;">
                     <input type="submit" class="btn submit_btn" style="width: 70%;padding:5px;" value="确定修改">
                </div>
...
if(isset($_GET['cid'])){
    ...
    $kw = isset($_GET['kw']);
    $numrows=$DB->getColumn("SELECT count(*) FROM shua_tools WHERE A.name LIKE '%$kw%' AND active=1");
	$sql=" A.name LIKE '%$kw%'";
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>商品详情</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
        ...
        <div class="hotxy block-white" id="tab">
        <div style="overflow-x: scroll;width: 100%;padding: 10px 0;display: flex;flex-direction: row;align-items: center;justify-content: space-between;width: 100%;">

            <a id="tab_0" href="./shoplist.php" style="margin:5px 15px 5px 15px;width: 20%;height: 55px;align-items: center;justify-content: space-between;display: flex;flex-direction: column;">
                <div style="height: 30px;width: 30px;display: inline-block;overflow: hidden;position: relative;">
                    <div style="background-image: url('/assets/img/all.png'); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;"></div>
                    <img src="/assets/img/all.png" style="width: 100%;height: 100%;">
                </div>
                <div style="font-size: 12px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">全部</div>
            </a>
            <?php echo $select?>
        </div>
...
$rs=$DB->query("SELECT * FROM shua_tools WHERE{$sql} ORDER BY sort DESC LIMIT $offset,$pagesize");
        if(isset($_GET['kw'])){$rs=$rscv;}
while($res = $rs->fetch())
{
                $fenzhan_top = $DB->getRow("SELECT * FROM shua_fenzhan_top WHERE tid='{$res['tid']}' AND zid='{$userrow['zid']}' LIMIT 1");
            if(!empty($fenzhan_top)){
               $top = 1; 
            }else{
               $top = 0; 
            }
...
echo ' <div class="list-item">
                                 <div class="list-item-top" style="padding-bottom: 10px">
                                      <div class="item-logo-1" style="width: auto;padding-right: 10px">
                                         <div class="item-logo-img" style="width: auto;padding: 0 25px">热门商品</div>
                                      </div>
                                 ...
                                 <div class="list-item-c">
                                     ...
                                     <div class="item-c-txet">
                                         <div class="item-c-title" style="font-size: 13px;">首页推荐</div>
                                         <div class="item-c-data">
                                             <label class="custom-switch">
                                                 <input type="checkbox" id="custom-switch_'.$res['tid'].'" data-tid="' . $res['tid'] . '"'. ($top == 1 ? "checked" : "") . '>"
...
$(document).ready(function(){
    $('.custom-switch input[type="checkbox"]').on('change', function() {
        ...
        updateSeparateStatus(tid, newState);
    });
    function updateSeparateStatus(tid, state) {
        $.post('ajax_user.php?act=custom-switch', {
                    tid:tid,
                    top: state,
                },
                    function (data) {
