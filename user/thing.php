...
<html lang="zh-cn" style="" class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers no-applicationcache svg inlinesvg smil svgclippaths"><head>
  ...
  <![endif]-->
<style>body{ background:#ecedf0 url("//cn.bing.com/th?id=OHR.ZebraEgret_ZH-CN8497454146_1920x1080.jpg&rf=LaDigue_1920x1080.jpg&pid=hp") fixed;background-repeat:no-repeat;background-size:100% 100%;}</style><link href="http://wzz.xgajidg.top/assets/kindeditor/themes/default/default.css" rel="stylesheet"></head>
<body>    <img src="//cn.bing.com/th?id=OHR.ZebraEgret_ZH-CN8497454146_1920x1080.jpg&amp;rf=LaDigue_1920x1080.jpg&amp;pid=hp" alt="Full Background" class="full-bg full-bg-bottom animation-pulseSlow" ondragstart="return false;" oncontextmenu="return false;">
...
<div class="block-white">
        <div class="block-back">
            <a href="./tougao.php" class="font-weight display-row align-center">
                ...
                <div class="input-group" style="width:100%">
                    ...
                    <span class="input-group-btn" style="padding-right: 10px">
                        <a href="javascript:fileSelect()" title="上传图片">
                             <img style="width: 8rem; height: 8rem; " id="fileimg" src="../assets/user/img/add_img.svg"></img>
...
$yhid=$userrow['zid'];
$sql="insert into `shua_tools` (`name`,`cid`,`pro`,`shopimg`,`desc`,`goods_param`,`wx_test`,`close`,`active`,`addtime`) values (:name,:cid,:pro,:shopimg,:desc,:goods_param,:wx_test,1,1,NOW())";
    ...
    function  openmsg() {
        layer.open({
            ...
            content: '<div class="showtip display-column  align-center"style="position: relative" >'+
                ...
                '<img style="width:100%" src="../assets/user/img/thing.png">'+
