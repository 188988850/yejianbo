    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 80px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>在线充值</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span>无需人工</span></a>
                    <div class="charge-btn"><a href="rechargecz.php" style="color: #fff;">去充值</a></div></div>
                    <div class="content-item-bottom">
                    <a href="rechargecz.php"><img src="../assets/img/rrzxczye2.png" style="width: 100%; height: 124px;"></a>
                </div>
            </div>
        </div>
...
layer.open({
    ...
    content:
        ...
        '<div style="padding:10px 15px;font-size: 1.3rem;color: #ff0000;line-height:2rem;letter-spacing:.1rem;">充值的余额仅作消费使用，不支持提现<br>禁止一切套现行为<br>介意请勿充</p>'+
