...
if(isset($_GET['kw'])){
    $kw=$_GET['kw'];
    $rscv=$DB->query("SELECT * FROM pre_videolist WHERE name LIKE '%{$kw}%' AND active=1");
}
$title='影视管理';
...
$numrows=$DB->getColumn("SELECT count(*) FROM pre_videolist");
    ...
    opacity: .8;align-items: center;justify-content: space-between;display: flex; flex-direction: row;height: 30px;">
        ...
        <div class="my-cell" style="margin-bottom: 0px;padding: 5px 10px;border-radius: 0">
            <div class="my-cell-title display-row justify-between align-center">
                <div class="my-cell-title-l left-title" style="font-size:1.3rem">影视管理</div>
...
<!--
            <a href="javascript:void(0)" onclick="auto_price(0)" style="font-size:1.3rem;" class="display-row align-center">
                <font style="margin-top: 2px;margin-right: 5px">新影视同步销售价格</font>
...
<?php $shopcid = intval($_GET['cid']);?>
       <?php  if($userrow['power']==2){?>
            <div class="btn-list display-row flex-wrap justify-between align-center">
                <a class="btn-item" style="width: 49%" class="btn btn-success" onclick="reset_price(0)" href="javascript:void(0)"><img src="../assets/user/img/huifu_price.png">恢复初始网盘下载价格</a>
                <a class="btn-item" style="width: 49%" class="btn btn-success" onclick="reset_bfprice(0)" href="javascript:void(0)"><img src="../assets/user/img/huifu_price.png">恢复初始全集播放价格</a>
                
                <a class="btn-item" style="width: 49%" href="javascript:void(0)" onclick="up_price(0)"><img src="../assets/user/img/up_price.png">提升网盘下载销售价格</a>
                <a class="btn-item" style="width: 49%" href="javascript:void(0)" onclick="up_bfprice(0)"><img src="../assets/user/img/up_price.png">提升全集播放销售价格</a>
                
                <a class="btn-item" style="width: 49%" href="javascript:void(0)" onclick="xiaji_up_price(0)"><img src="../assets/user/img/xiaji_price.png">提升网盘下载下级价格</a>
                <a class="btn-item" style="width: 49%" href="javascript:void(0)" onclick="xiaji_bfup_price(0)"><img src="../assets/user/img/xiaji_price.png">提升全集播放下级价格</a>
                
                
                <a class="btn-item" style="width: 49%" class="btn btn-success" onclick="reset_dbprice(0)" href="javascript:void(0)"><img src="../assets/user/img/huifu_price.png">恢复初始单集播放价格</a>
                <a class="btn-item" style="width: 49%" href="javascript:void(0)" onclick="up_dbprice(0)"><img src="../assets/user/img/up_price.png">提升单集播放销售价格</a>
                <a class="btn-item" style="width: 49%" href="javascript:void(0)" onclick="xiaji_djup_price(0)"><img src="../assets/user/img/xiaji_price.png">提升单集播放下级价格</a>
...
?>
        ...
        <div class="form-group form-group-transparent" style="background: #f2f2f2; padding:8px 10px">
            ...
            <form action="./videolist.php?my=edit_submit&id=<?php echo $id ?>" method="POST">
                <div class="block-white" style="padding: 0 10px">
                    ...
                    <div class="form-group form-group-transparent form-group-border-bottom">
                        ...
                        <div class="form-group form-group-transparent form-group-border-bottom">
                            <div class="input-group" style="width:100%">
                                ...
                                <input type="text" class="form-control" name="cost2" value="<?php echo $price_obj->getVideoCost2($id) ?>" disabled="">
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-transparent form-group-border-bottom">
                            <div class="input-group" style="width:100%">
                                ...
                                <input type="text" class="form-control" name="cost" value="<?php echo $price_obj->getVideoCost($id) ?>">
                            </div>
                        </div>
                    <div class="form-group form-group-transparent">
                        <div class="input-group" style="width:100%">
                            ...
                            <input type="text" class="form-control" name="price" value="<?php echo $price_obj->getVideoPrice($id) ?>">
                    ...
                    <div class="form-group form-group-transparent" style="background: #f2f2f2; margin: 0 -10px;padding-left: 10px">
                     ...
                     <div class="form-group form-group-transparent form-group-border-bottom">
                            <div class="input-group" style="width:100%">
                                ...
                                <input type="text" class="form-control" name="bfcost2" value="<?php echo $price_obj->getbfVideoCost2($id) ?>" disabled="">
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-transparent form-group-border-bottom">
                            <div class="input-group" style="width:100%">
                                ...
                                <input type="text" class="form-control" name="bfcost" value="<?php echo $price_obj->getbfVideoCost($id) ?>">
                            </div>
                        </div>
                    <div class="form-group form-group-transparent">
                        <div class="input-group" style="width:100%">
                            ...
                            <input type="text" class="form-control" name="bfprice" value="<?php echo $price_obj->getbfVideoPrice($id) ?>">
...
$price_obj->setVideoInfo($id,$rows);
$price=round(daddslashes($_POST['price']),2);
$mainprice = $price_obj->getMainPrice();//主站影视售价
$maincost = $price_obj->getMainCost();//主站影视成本价
...
if($userrow['power']==2){
	...
	if($cost<$price_obj->getVideoCost2($id)){
	...
	if($conf['fenzhan_pricelimit']==1 && $maincost>0 && ($maincost>1 && $cost>$maincost*2 || $maincost<=1 && $price>2))
		showmsg('下级价格最高不能超过原代理价格的2倍（低于1元的影视，代理价格最高不能超过2元）',3);
}else{
	if($price<$price_obj->getVideoCost($id)){
		showmsg('销售价格不能低于成本价格！',3);
	}
	$cost=0;
}
if($conf['fenzhan_pricelimit']==1 && ($mainprice>1 && $price>$mainprice*2 || $mainprice<=1 && $price>2))
	showmsg('影视售价最高不能超过原售价的2倍（低于1元的影视，售价最高不能超过2元）',3);
	
if($price_obj->setvPriceInfo($id,$del,$price,$cost))
	showmsg('修改影视成功！',1);
else
	showmsg('修改影视失败！'.$DB->error(),4);
}
elseif($my=='reset')
{
...
if(isset($_GET['kw'])){
    $kw = isset($_GET['kw']);
    $numrows=$DB->getColumn("SELECT count(*) FROM pre_videolist WHERE A.name LIKE '%$kw%' AND active=1");
	$sql=" A.name LIKE '%$kw%'";
	$con='包含 <b>'.$kw.'</b> 的共有 <b>'.$numrows.'</b> 部影视';
	$link='&kw='.$kw;
}else{
	$numrows=$DB->getColumn("SELECT count(*) FROM pre_videolist WHERE active=1");
	$sql=" active=1";
	$con='
	<div class="panel panel-default"><div class="panel-heading font-bold" style="background-color: #9999CC;color: white;">影视列表</div>
	<div class="well well-sm" style="margin: 0;">系统共有 <b>'.$numrows.'</b> 部影视 - 提升价格赚的更多哦！提高价格最好不要太贵了否则没人买的哦！</div>
    <div class="wrapper">
...
?>
        ...
        <div class="my-cell" style="margin-bottom: 0px;padding: 5px 10px;border-radius: 0">
            <div class="my-cell-title display-row justify-between align-center">
                <div class="my-cell-title-l left-title" style="font-size:1.3rem">影视详情</div>
                <div class="my-cell-title-r  display-row  align-center">
                    <span style="color: #939393;font-size:1.3rem">共<?php echo ''.$numrows.'' ?>部影视</span>
                </div>
            </div>
<br>
...
$rs=$DB->query("SELECT * FROM pre_videolist WHERE{$sql} ORDER BY id DESC LIMIT $offset,$pagesize");

while($res = $rs->fetch())
{
	$price_obj->setVideoInfo($res['id'],$res);

echo ' <div class="list-item">
                                 <div class="list-item-top" style="padding-bottom: 10px">
                                      <div class="item-logo-1" style="width: auto;padding-right: 10px">
                                         <div class="item-logo-img" style="width: auto;padding: 0 25px">站长推荐影视</div>
                                      </div>
                                      
                                 </div>
                                 <div class="list-item-c">
                                     <div class="item-c-txet" style="line-height: normal;">
                                         <div class="item-c-title" style="font-size: 13px;">影视名称</div>
                                         <div class="item-c-data">'.$res['name'].'</div>
                                     </div>
                                     <div class="item-c-txet">
                                         <div class="item-c-title" style="font-size: 13px;">网盘下载成本价格</div>
                                         <div class="item-c-data">￥'.($userrow['power']==2?$price_obj->getVideoCost2($res['id']).'</div>
                                     </div>
                                     <div class="item-c-txet">
                                         <div class="item-c-title" style="font-size: 13px;">网盘下载下级价格</div>
                                         <div class="item-c-data">￥'.$price_obj->getVideoCost($res['id']):$price_obj->getVideoCost($res['id'])).'</div>
                                     </div>
                                     <div class="item-c-txet">
                                         <div class="item-c-title" style="font-size: 13px;">网盘下载销售价格</div>
                                         <div class="item-c-data">￥'.$price_obj->getVideoPrice($res['id']).'</div>
                                     </div>
                                     
                                     <div class="item-c-txet">
                                         <div class="item-c-title" style="font-size: 13px;">在线播放成本价格</div>
                                         <div class="item-c-data">￥'.($userrow['power']==2?$price_obj->getbfVideoCost2($res['id']).'</div>
                                     </div>
                                     <div class="item-c-txet">
                                         <div class="item-c-title" style="font-size: 13px;">在线播放下级价格</div>
                                         <div class="item-c-data">￥'.$price_obj->getVideoCost($res['id']):$price_obj->getbfVideoCost($res['id'])).'</div>
                                     </div>
                                     <div class="item-c-txet">
                                         <div class="item-c-title" style="font-size: 13px;">在线播放销售价格</div>
                                         <div class="item-c-data">￥'.$price_obj->getbfVideoPrice($res['id']).'</div>
                                     </div>
...
if ($page>1)
{
echo '<li><a href="videolist.php?page='.$first.$link.'">首页</a></li>';
echo '<li><a href="videolist.php?page='.$prev.$link.'">&laquo;</a></li>';
} else {
...
echo '<li><a href="videolist.php?page='.$i.$link.'">'.$i .'</a></li>';
echo '<li class="disabled"><a>'.$page.'</a></li>';
for ($i=$page+1;$i<=$end;$i++)
echo '<li><a href="videolist.php?page='.$i.$link.'">'.$i .'</a></li>';
if ($page<$pages)
{
echo '<li><a href="videolist.php?page='.$next.$link.'">&raquo;</a></li>';
echo '<li><a href="videolist.php?page='.$last.$link.'">尾页</a></li>';
} else {
...
function reset_price(cid) {
    layer.open({
        ...
        content:
            ...
            '<div class="showtip-center-num" style="font-size: 1.2rem">重置所有影视价格至最初状态</div>' +
            '</div>'+
            '</div>',
        btn1: function(index, layero){
            $.ajax({
                type: "post",
                url: "ajax_user.php?act=reset_vprice",
                data: {
                    cid: cid
                },
                dataType: "json",
            ...
            '</div>',
                yes: function (index,layero) {
                    ...
                    $.ajax({
                        type: 'post',
                        dataType: 'json',
                        url: '/api_ajax.php?act=up_vprice',
                        cache: false,
            ...
            '</div>',
                yes: function (index,layero) {
                    ...
                    $.ajax({
                        type: 'post',
                        dataType: 'json',
                        url: '/api_ajax.php?act=xiaji_up_vprice',
                        cache: false,
                        data: {zid:<?=$userrow['zid']?>,up:text,type:type},
                        success: function(data){
                            if(data.code==0){
...
function reset_dbprice(cid) {
    layer.open({
        ...
        btn1: function(index, layero){
            $.ajax({
                type: "post",
                url: "ajax_user.php?act=reset_vdbprice",
                data: {
                    cid: cid
                },
                dataType: "json",
            ...
            '</div>',
                yes: function (index,layero) {
                    ...
                    $.ajax({
                        type: 'post',
                        dataType: 'json',
                        url: '/api_ajax.php?act=up_vdbprice',
                        cache: false,
                        data: {zid:<?=$userrow['zid']?>,up:text,type:type},
                        success: function(data){
                            if(data.code==0){
            ...
            '</div>',
                yes: function (index,layero) {
                    ...
                    $.ajax({
                        type: 'post',
                        dataType: 'json',
                        url: '/api_ajax.php?act=xiaji_up_vdbprice',
                        cache: false,
                        data: {zid:<?=$userrow['zid']?>,up:text,type:type},
                        success: function(data){
                            if(data.code==0){
...
function reset_bfprice(cid) {
    layer.open({
        ...
        btn1: function(index, layero){
            $.ajax({
                type: "post",
                url: "ajax_user.php?act=reset_vbfprice",
                data: {
                    cid: cid
                },
                dataType: "json",
            ...
            '</div>',
                yes: function (index,layero) {
                    ...
                    $.ajax({
                        type: 'post',
                        dataType: 'json',
                        url: '/api_ajax.php?act=up_vbfprice',
                        cache: false,
                        data: {zid:<?=$userrow['zid']?>,up:text,type:type},
                        success: function(data){
                            if(data.code==0){
            ...
            '</div>',
                yes: function (index,layero) {
                    ...
                    $.ajax({
                        type: 'post',
                        dataType: 'json',
                        url: '/api_ajax.php?act=xiaji_up_vbfprice',
                        cache: false,
                        data: {zid:<?=$userrow['zid']?>,up:text,type:type},
                        success: function(data){
                            if(data.code==0){
    ...
    function auto_price() {
        ...
        layer.open({
            ...
            content:
                ...
                '<div class="showtip-title" style="height: 1rem"></div>' +
                '<div class="showtip-center  display-column justify-center align-center" style="width: 100%">'+
                '<div class="showtip-center-msg">新影视自动同步影视价格</div>'+
                '<div class="showtip-center-num" style="width: 100%;margin-bottom: 15px">' +
                ...
                '<p style="font-size:.95rem;color: #999999;padding: 0 10px;margin-top: 10px; line-height: 1.6rem">*自动同步影视价格,是根据您选择的提升类型,自动提升最新影视的价格(只同步后期新上架影视)</p>'+
                '</div>'+
    ...
    function  openmsg1() {
        layer.open({
            ...
            content: '<center><div class="showtip display-column  align-center" style="background:#FFF">'+
                ...
                '<font style="font-weight: 800;line-height: 3rem">如何提升影视售价？</font><br>'+
                '<font style="color: #999999">点击提升售价，选择百分比或者固定金额，输入数字整数，百分比输入10=提升10%售价，固定金额输入10=提升10元售价，影视售价不做上限要求，具体由您自己设定。</font><br>'+
                '</div>'+
