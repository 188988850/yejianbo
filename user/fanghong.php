   ...
   <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 80px;">
        <div class="content-item">
            <div class="content-item-top">
                ...
                <div style="padding: 5px 0;font-size: 1.3rem;color: #858585;">
                    ...
                    <font color="#ff0000">更换域名后之前的推广链接和二维码将失效，更换后请重新获取~</font>
                </div>
                </div>
            </div>
        </div>
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    <img src="../assets/img/icon/anquan.png" style="width: 20px; margin-right: 10px;">
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>直链COS链接</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    <div class="charge-btn"><a href="tuiguangcos.php" style="color: #fff;">生成推广码</a>
                    </div></div>
                    <div class="content-item-bottom">
                <div style="padding: 5px 0;font-size: 1.3rem;color: #858585;">
                    <font color="#980000">COS链接：<br></font>
                    <font color="#000">浏览器访问链接直接到自己站里</font><br><br>
                    <font color="#980000">当前链接： (点击可访问)<br></font>
                    <font color="#000"><a href="https://ss03-1302784280.cos-website.ap-nanjing.myqcloud.com/?zid=<?php echo $zid?>" target="_blank" rel="noreferrer">https://ss03-1302784280.cos-website.ap-nanjing.myqcloud.com/?zid=<?php echo $zid?></a></font>
                    <a style="width: 100%;" href="javascript:;" id="copy-btn1" data-clipboard-text="https://ss03-1302784280.cos-website.ap-nanjing.myqcloud.com/?zid=<?php echo $zid?>">
                    <img style="width:20px;height:30px;padding-left:0px" src="../assets/store/img/fuzhi.svg" />
                        </a>
                    <br><br>
                    <font color="#980000">注意：<br></font>
                    <font color="#000">微信/QQ推广不了，访问会报红，其它地方无问题~</font><br><br>
                    <font color="#980000">小提示：<br></font>
                    <font color="#000">链接过长可使用缩短链接来进行推广，<a style="color: #4a86e8;" href="https://www.985.so/">点我进入缩短链接网站</a>（选择2号生成即可）</font><br><br>
                </div>
                </div>
            </div>
        </div>
