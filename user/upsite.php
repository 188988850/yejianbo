...
if($upzid > 0){
	...
	$upsite = $DB->getRow("SELECT zid,power,ktfz_price2 FROM shua_site WHERE zid='$upzid' LIMIT 1");
...
if($_GET['act']=='submit'){
	...
	$DB->exec("UPDATE `shua_site` SET `power`=2,`rmb`=`rmb`-'{$price}' WHERE `zid`='{$userrow['zid']}'");
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 80px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>顶级合伙人介绍</span></a>
                ...
                <div style="padding: 0px 0;font-size: 1.3rem;color: #858585;">
                    <font color="#000">顶级合伙人享旗下所有分站站长管理功能，无限极差赚取下级分站提成，平台内的知识课程成本最低0元每件，升级顶级合伙人利润更高，收益更大！</font>
        <br><br>
        <i class="my-cell-title-l left-title"></i><font color="black">可享受知识付费商品全部免费购买</span></p>
        <br>
...
<div style="background: #f2f2f2; height: 10px"></div>
		...
		<div class="panel-body">
			...
			<a class="btn submit_btn" style="width: 70%;padding:5px;" href="?act=submit">立即升级</a>
		</div>
	</div>
   </div>
  </div>
