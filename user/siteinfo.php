    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 80px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>我的站点信息</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    </div>
                    <div class="content-item-bottom">
                       <div style="padding: 15px 5px;background: #f7f7f7;border-radius: 5px;width: 100%;font-size: 1.4rem">
       ...
       <?php  if($userrow['power']==2){?>
                    ...
                    <div class="li-list-item">
                        ...
                        <div class="item-info">
                            <a target="_blank" rel="noreferrer">https://.........</a>
                        </div>

                        <a href="promotion1.php" class="item-right">查看</a>
                    </div>
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>平台收益介绍</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    </div>
                    <div class="content-item-bottom">
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>站点公告</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    </div>
                    <div class="content-item-bottom">
       ...
       <div>
                ...
                <a  style="width: 100%;" href="promotion1.php" >
                    <div class="submit_btn" style="width:70%;height: 3.5rem;margin:10px auto;text-align: center;line-height: 3.5rem;border-radius: 30px">立即生成海报 </div>
                </a>
            </div>
