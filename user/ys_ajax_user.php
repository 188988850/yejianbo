...
break;
case 'reset_vprice':
	$DB->exec("UPDATE pre_site SET vprice=NULL WHERE zid='{$userrow['zid']}'");
	exit('{"code":0}');
break;
case 'reset_vbfprice':
	$DB->exec("UPDATE pre_site SET vbfprice=NULL WHERE zid='{$userrow['zid']}'");
	exit('{"code":0}');
break;
case 'reset_vdbprice':
	$DB->exec("UPDATE pre_site SET vdbprice=NULL WHERE zid='{$userrow['zid']}'");
	exit('{"code":0}');
break;
case 'up_price':
	unset($islogin2);
