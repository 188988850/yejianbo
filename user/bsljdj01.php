    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 80px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <div class="content-item-bottom">
                <div style="padding: 0px 0;font-size: 1.3rem;color: #858585;">
                    <font color="#000">用户通过你站点开通VIP会员即可得到佣金
                </div>
                </div>
            </div>
        </div>
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <div class="content-item-bottom">
                <div style="padding: 0px 0;font-size: 1.3rem;color: #858585;">
                    <font color="#000">仅分站站长、顶级合伙人级别才能享受分佣，普通用户不参与<br>
                    推广享受50%佣金分佣<br>
                    比如你邀请的用户支付2元开通VIP会员，你将获得1元佣金
                    </font><br>
                </div>
                </div>
            </div>
        ...
        <div class="content-item">
            <div class="content-item-top">
                ...
                <div style="padding: 5px 0;font-size: 1.3rem;color: #858585;">
                    ...
                    <font color="#000"><a href="<?php // 动态获取当前域名（支持 HTTP/HTTPS 自动判断） $current_site_url = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https://" : "http://") . $_SERVER['HTTP_HOST']; echo $current_site_url . '?zid=' . $zid; ?>" target="_blank" rel="noreferrer"><?php // 动态获取当前域名（支持 HTTP/HTTPS 自动判断） $current_site_url = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https://" : "http://") . $_SERVER['HTTP_HOST']; echo $current_site_url . '?zid=' . $zid; ?></a></font>
                    <a style="width: 100%;" href="javascript:;" id="copy-btn1" data-clipboard-text="<?php // 动态获取当前域名（支持 HTTP/HTTPS 自动判断） $current_site_url = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https://" : "http://") . $_SERVER['HTTP_HOST']; echo $current_site_url . '?zid=' . $zid; ?>">
        ...
        <div class="layui-carousel" id="test1" lay-filter="test1" style="margin: 25px auto; width: 95%; height: 50vh;" lay-anim="" lay-indicator="outside" lay-arrow="always">
            <div carousel-item="" class="text-center">
                <div class="layui-this">
                    <img style=" height: 50vh" id="img_1" src="./timg/duanju.php?id=1&url=<?php // 动态获取当前域名（支持 HTTP/HTTPS 自动判断） $current_site_url = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https://" : "http://") . $_SERVER['HTTP_HOST']; echo $current_site_url . '?zid=' . $zid; ?>" alt="推广图1"></div>
        </div>
    </div>
       </div>
    </div>
