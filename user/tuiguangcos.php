        ...
        <div class="content-item">
            <div class="content-item-top">
                ...
                <div style="padding: 0px 0;font-size: 1.3rem;color: #858585;">
                    ...
                    3.好友通过您的分享注册将成为您的下级，他们产生的订单都会给您带来收益</font><br><br>
                    
                    <font color="#ff0000">提示：该二维码在微信/QQ推广不了，访问会报红，其它地方无问题~</font>
                </div>
                </div>
            </div>
        </div>
        ...
        <div class="layui-carousel" id="test1" lay-filter="test1" style="margin: 25px auto; width: 95%; height: 50vh;" lay-anim="" lay-indicator="outside" lay-arrow="always">
            <div carousel-item="" class="text-center">
                <div class="layui-this">
                    <img style=" height: 50vh" id="img_1" src="./timg/timg.php?id=1&url=https://ss03-1302784280.cos-website.ap-nanjing.myqcloud.com/?zid=<?php echo $zid?>" alt="推广图1"></div>
                <div>
                    <img style=" height: 50vh" id="img_2" src="./timg/timg.php?id=2&url=https://ss03-1302784280.cos-website.ap-nanjing.myqcloud.com/?zid=<?php echo $zid?>" alt="推广图2"></div>
                <div>
                    <img style=" height: 50vh" id="img_3" src="./timg/timg.php?id=3&url=https://ss03-1302784280.cos-website.ap-nanjing.myqcloud.com/?zid=<?php echo $zid?>" alt="推广图3"></div>
                <div>
                    <img style=" height: 50vh" id="img_4" src="./timg/timg.php?id=4&url=https://ss03-1302784280.cos-website.ap-nanjing.myqcloud.com/?zid=<?php echo $zid?>" alt="推广图4"></div>
                <div>
                    <img style=" height: 50vh" id="img_5" src="./timg/timg.php?id=5&url=https://ss03-1302784280.cos-website.ap-nanjing.myqcloud.com/?zid=<?php echo $zid?>" alt="推广图5"></div>
                <div>
                    <img style=" height: 50vh" id="img_6" src="./timg/timg.php?id=6&url=https://ss03-1302784280.cos-website.ap-nanjing.myqcloud.com/?zid=<?php echo $zid?>" alt="推广图6"></div>
                <div>
