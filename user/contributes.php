...
<?php
if($userrow['power']==0 || $userrow['power']==1){
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 20px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>项目投稿</span></a>
...
?>
            ...
            <div class="form-group form-group-transparent">
                <div class="input-group" style="width:100%">
                    ...
                    <div class="form-control  form-control-left" style="color:#696969">图片请放置在资源网盘里</div>
                </div>
            </div>
            <div class="form-group form-group-transparent">
                <div align="center"><div style="width: 95%;"><textarea name="desc" style="width:100%;height:150px" placeholder=" 请输入项目介绍"/></textarea><font color="green">
                </div>
            </div>
            <div class="form-group form-group-transparent">
                <div class="input-group" style="width:100%">
            ...
            <div class="form-group form-group-transparent form-group-border-bottom">
                ...
                <div class="text-center" style="padding: 15px 10px;">
                    <input type="submit"class="btn submit_btn" style="width: 70%;padding:5px;" value="确定提交">
                </div>
        </form>
...
$yhid=$userrow['zid'];
$sql="insert into `shua_tools` (`name`,`cid`,`pro`,`shopimg`,`desc`,`zyurl`,`wx_test`,`close`,`active`,`addtime`) values (:name,:cid,:pro,:shopimg,:desc,:zyurl,:wx_test,1,0,NOW())";
