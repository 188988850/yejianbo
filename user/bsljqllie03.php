        ...
        <div class="content-item">
            <div class="content-item-top">
                ...
                <div style="padding: 5px 0;font-size: 1.3rem;color: #858585;">
                    ...
                    <font color="#000"><a href="<?php echo $conf['coslb03'] ?>?zid=<?php echo $zid?>" target="_blank" rel="noreferrer"><?php echo $conf['coslb03'] ?>?zid=<?php echo $zid?></a></font>
                    <a style="width: 100%;" href="javascript:;" id="copy-btn1" data-clipboard-text="<?php echo $conf['coslb03'] ?>?zid=<?php echo $zid?>">
        ...
        <div class="layui-carousel" id="test1" lay-filter="test1" style="margin: 25px auto; width: 95%; height: 50vh;" lay-anim="" lay-indicator="outside" lay-arrow="always">
            <div carousel-item="" class="text-center">
                <div class="layui-this">
                    <img style=" height: 50vh" id="img_1" src="./timg/qunliao.php?id=1&url=<?php echo $conf['coslb03'] ?>?zid=<?php echo $zid?>" alt="推广图1"></div>
        </div>
    </div>
       </div>
    </div>
