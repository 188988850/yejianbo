...
<div class="col-xs-12 col-sm-10 col-md-6 col-lg-4 center-block " style="float: none; background-color:#fff;padding:0;max-width: 550px;">
    ...
    opacity: .8;align-items: center;justify-content: space-between;display: flex; flex-direction: row;height: 30px;">
                <a href="promotion1.php"  class="font-weight display-row align-center" style="height: 1.6rem;line-height: 1.65rem;width: 50%">
        ...
        <div class="content-item">
            <div class="content-item-top">
                ...
                <div style="padding: 5px 0;font-size: 1.3rem;color: #858585;">
                    ...
                    <font color="#000">如遇自己网站无法正常访问但别人的站可以访问的，可进行更换新的后缀域名来恢复正常访问。</font><br><br>
                    ...
                    <font color="#ff0000">1.请勿使用上面链接进行推广！（大概率是报红的）<br>
                    2.更换上面网站域名后下面的活码推广链接不会变，无需再进行更换推广链接！</font>
                </div>
                </div>
            </div>
        </div>
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>推广链接</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
                    </div>
                    <div class="content-item-bottom">
                <div style="padding: 5px 0;font-size: 1.3rem;color: #858585;">
                    ...
                    <font color="#000"><a href="<?php echo $conf['costg02'] ?>?zid=<?php echo $zid?>" target="_blank" rel="noreferrer"><?php echo $conf['costg02'] ?>?zid=<?php echo $zid?></a></font>
                    <a style="width: 100%;" href="javascript:;" id="copy-btn1" data-clipboard-text="<?php echo $conf['costg02'] ?>?zid=<?php echo $zid?>">
                    <img style="width:20px;height:30px;padding-left:0px" src="../assets/store/img/fuzhi.svg" />
                        </a>
                    <br><br>
                    <font color="#980000">小提示：<br></font>
                    <font color="#000">链接过长可把链接缩短方便推广，<a style="color: #4a86e8;" href="https://www.985.so/" target="_blank">点我进入缩短链接网站</a>（选择2号生成即可）</font><br><br>
                </div>
                </div>
            </div>
        </div>
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding-top: 11px;">
        <div class="content-item">
            <div class="content-item-top">
                    ...
                    <a style="font-weight: 600; font-size: 16px; margin-right: 8px;"><span>推广二维码</span></a>
                    <a style="font-size: 14px; color: rgb(255, 91, 33); padding-left: 11px;"><span></span></a>
        ...
        <div class="layui-carousel" id="test1" lay-filter="test1" style="margin: 25px auto; width: 95%; height: 50vh;" lay-anim="" lay-indicator="outside" lay-arrow="always">
            <div carousel-item="" class="text-center">
                <div class="layui-this">
                    <img style=" height: 50vh" id="img_1" src="./timg/timg.php?id=1&url=<?php echo urlencode('http://' . $userrow['domain']); ?>" alt="推广图1"></div>
                <div>
                    <img style=" height: 50vh" id="img_2" src="./timg/timg.php?id=2&url=<?php echo urlencode('http://' . $userrow['domain']); ?>" alt="推广图2"></div>
                <div>
                    <img style=" height: 50vh" id="img_3" src="./timg/timg.php?id=3&url=<?php echo urlencode('http://' . $userrow['domain']); ?>" alt="推广图3"></div>
                <div>
                    <img style=" height: 50vh" id="img_4" src="./timg/timg.php?id=4&url=<?php echo urlencode('http://' . $userrow['domain']); ?>" alt="推广图4"></div>
                <div>
                    <img style=" height: 50vh" id="img_5" src="./timg/timg.php?id=5&url=<?php echo urlencode('http://' . $userrow['domain']); ?>" alt="推广图5"></div>
                <div>
                    <img style=" height: 50vh" id="img_6" src="./timg/timg.php?id=6&url=<?php echo urlencode('http://' . $userrow['domain']); ?>" alt="推广图6"></div>
                <div>
        </div>
    </div>
       </div><br>
