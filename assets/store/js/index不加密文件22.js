	   ...
	   $(".hotxy").hide();
	    ...
	    if(cid!=cidrd.cid){}else{
	    		...
	    		$.each(cidrd.data, function (i, res) {
					$("#classtab").append(' <a data-cid="'+res.cid+'" data-name="'+res.name+'" onclick="cidr('+res.cid+')" class="get_tab tab-bottom-item"><img style="height: 1rem;padding: 0rem 0.1rem 0.1rem;" src="'+res.shopimg+'" alt="" />'+res.name+'</a>');
                        ...
                        console.log(res);
                            ...
                            layui.each(res.data, function(index, item){
                                ...
                                //库存为0的
                                    ...
                                    html += '<div class="detail" style="height:unset;border-radius: 0px 0px 10px 10px;">';
                                    html += '<div class="name" style="font-size: 10px;color: #666666;font-family: PingFangHK-Medium, PingFangHK;font-weight:500;"><i class="fa fa-caret-right" style="color: #ff0000;"></i> '+item.classname+' <i class="fa fa-caret-right" style="color: #4a86e8;"></i> 库存:'+item.stock+'<div style="font-size: 13px;color: #000000;font-family: PingFangHK-Medium, PingFangHK;">'+item.name+'</div></div>';
                                    html += '<br>';
                                    var price = '';
                                    if(item.price <= 0){
                                        price = '';
                            ...
                            if(kw != ""){
                                ...
                                $(".catname_show").html('包含<font style="color: #7d7c7a;font-size: 12px;">'+kw+'</font>共有<font style="">'+res.total+'</font>件商品');
                                   ...
                                   $(".catname_c").hide(); $(".catname_show").show();  $(".catname_cc").hide();
                                   $(".catname_show").html('<font style="font-size: 16px; color: rgb(0, 0, 0);">精品推荐</font> <font style="font-size: 12px; color: #999;">（'+res.total+'个商品）</font>');
                                   }
                            layer.closeAll();
