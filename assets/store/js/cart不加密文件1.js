                ...
                if (data.code == 0) {
                    ...
                    $.each(data.data, function (key, val) {
                        ...
                        content += '<li>\n' +
                            ...
                            '              <div class="product-item fui-goods-item" style="padding: 10px;">\n' +
                            '                  <img src="' + val.shopimg + '" onerror="this.src=\'assets/store/picture/error_img.png\'"style="width: 30%; border-radius: 5px;"/>\n' +
                            '                <div class="product-info">\n' +
                            '                <div class="product-name" style="font-size: .6rem;color: #585858;">' + val.name + '</div>\n' +
                            '                <div class="product-price" style="font-size: .6rem;color: #e65a7e;">价格:' + val.price + '</div>\n' +
                            '               </div>\n' +
                            '           </div>\n' +
                            '          </a>\n' +
                            '      </li>';
    ...
    Success: function (data) {
        ...
        $.each(data.data, function (key, val) {
            ...
            content += '<div class="gwcone" id="CartShop_' + val.id + '" data-count="' + val.num + '" data-multi="' + val.multi + '">\n' +
                ...
                '                </div>\n' +
                '                <div class="go2"><a href="./?mod=buy1&cid=' + val.cid + '&tid=' + val.tid + '"><img src="' + val.shopimg + '" onerror="this.src=\'assets/store/picture/error_img.png\'"/></a></div>\n' +
                '                <div class="go3">\n' +
                '                    <div class="go3_1">\n' +
                '                        <a href="./?mod=buy1&cid=' + val.cid + '&tid=' + val.tid + '"><p class="p1">' + val.name + '</p></a>\n' +
