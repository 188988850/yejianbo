		...
		success : function(data) {
			...
			if(data.code == 0){
                if(data.video_info){
                    ...
                    item += '<tr><td colspan="6" class="orderTitle page-title" style="padding:0"><b>影视订单详情</b></td></tr></tbody>';
                    item += '<tbody class="tbody" style="background: #f7f7f8;border-radius: 0px " border="0px" >';
                    if(v.cover){
                        item += '<tr><td class="orderTitle">封面</td><td colspan="5" class="orderContent"><img src="'+v.cover+'" style="max-width:120px;max-height:120px;"/></td></tr>';
                    }
                    item += '<tr><td class="orderTitle">影视名称</td><td colspan="5" class="orderContent">'+(v.title||'')+'</td></tr>';
                    item += '<tr><td class="orderTitle">订单编号</td><td colspan="5" class="orderContent"><span id="orderid">'+id+'</span></td></tr>';
                    item += '<tr><td class="orderTitle">订单金额</td><td colspan="5" class="orderContent">￥'+(v.price||data.money)+'</td></tr>';
                    item += '<tr><td class="orderTitle">下单时间</td><td colspan="5">'+data.date+'</td></tr>';
                    if(v.episodes){
                        item += '<tr><td class="orderTitle">集数</td><td colspan="5" class="orderContent">'+v.episodes+'</td></tr>';
                    }
                    if(v.netdisk){
                        item += '<tr><td class="orderTitle">网盘地址</td><td colspan="5" class="orderContent">'+v.netdisk+'</td></tr>';
                    }
                    if(v.desc){
                        item += '<tr><td class="orderTitle">简介</td><td colspan="5" class="orderContent">'+v.desc+'</td></tr>';
                    }
                    item += '</tbody></table>';
				...
				if(data.download_url==''){
				    item += '<tr><td class="orderTitle">下单信息</td><td colspan="5" class="orderContent">'+data.inputs+'</td></tr>';
				}else{
				    item += '<tr><td class="orderTitle">网盘地址</td><td colspan="5" class="orderContent">'+data.download_url+'</td></tr>';
				}	
