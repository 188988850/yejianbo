                        ...
                        console.log(res);
                            ...
                            layui.each(res.data, function(index, item){
                                ...
                                //库存为0的
                                    ...
                                    html += '<div class="name" style="color: #000000;font-size:.55rem;">'+item.name+'</div>';
                                    html += '<div class="addtime" style="color: #797979;font-size:.52rem;"><i class="layui-icon layui-icon-time" style="font-size:.55rem;"></i>上架时间:'+timestampToTime(item.addtime)+'</div>';
                                    ...
                                    html += '<div class="price" style="color: #ff8000;margin-top: .4rem;">'+price+'</div>';
                                    if(item.price <=0){
                                        ...
                                        buy = '<div style="height: 1.2rem"><span class="buy" style="background: #ff8000;color:#fff;display: inline-block;height: 1.2rem;line-height: 1.1rem;float: right;padding: 0rem 0.45rem;width:100%;border-radius: 0.2rem;    border: 1px solid transparent;text-align:center;">购买</span></div>';
                                    }
