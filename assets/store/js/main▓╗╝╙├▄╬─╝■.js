	...
	if(inputsname!=''){
		$.each(inputsname.split('|'), function(i, value) {
			...
			if(value.indexOf('{')>0 && value.indexOf('}')>0){
				...
				$('#inputsname').append('<div class="form-group form-group-transparent form-group-border-bottom"><div class="input-group" style="width:100%"><label class="input-group-addon" id="inputname'+(i+2)+'">'+selectname+'：</label><div class="layui-input-"><select name="inputvalue'+(i+2)+'" id="inputvalue'+(i+2)+'" class="form-control">'+addstr+'</select></div></div></div>');
			}else if(inputsnametype=='multi'){
				$('#inputsname').append('<div class="form-group form-group-transparent form-group-border-bottom"><div class="layui-form-item"><label class="layui-form-label"  style="width: 100%;text-align: left;padding:0" id="inputname'+(i+2)+'" gettype="'+inputsnametype+'">'+value+'：</label><div class="layui-input-"><input type="number" name="inputvalue'+(i+2)+'" id="inputvalue'+(i+2)+'" value="1" class="layui-input" required min="1" max="99999" onchange="getmulti(this)" act="getmulti"/></div></div></div>');
