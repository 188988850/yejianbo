                            ...
                            layui.each(res.data, function(index, item){
                                ...
                                //库存为0的
                                    ...
                                    if(item.price <=0){
                                        ...
                                        buy = '<div style="height: 2rem"><span class="buy" style="font-size: 13px;background: #fd2411;color:#fff;display: inline-block;height: 2rem;line-height: 0.9rem;float: right;padding: 0.05rem 0.45rem;width:100%;border-radius: 0.2rem;    border: 1px solid transparent;text-align:center;">马上抢<br>正在热卖</span></div>';
                                    }
