...
$(function() {
    ...
    if($.cookie('goods_list_style') == 'list'){
        ...
        $("#listblock").removeClass("icon-app");
        $("#listblock").addClass("icon-sort");
                    ...
                    success : function(res) {
                        console.log(res);
                            ...
                            layui.each(res.data, function(index, item){
                                ...
                                //库存为0的
                                    var shoukong = '';
                                    var kucun = '<p style="font-size: 10px;">￥<span style="color: #f03867;font-size: 14px;">'+item.price+'</span></p>';
                            ...
                            if(kw != ""){
                                ...
                                $(".catname_show").html('包含<font style="color: #7d7c7a;font-size: 12px;">'+kw+'</font>共有<font style="">'+res.total+'</font>件商品');
                                   ...
                                   $(".catname_c").hide(); $(".catname_show").show();  $(".catname_cc").hide();
                                   $(".catname_show").html('全站商品共1'+res.count+'个,当前'+res.total+'个');                            }
                            layer.closeAll();
