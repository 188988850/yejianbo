...
?>
	  <div class="table-responsive">
        <table class="table table-striped">
          ...
          <thead><tr><th>用户ID</th><th>上级ID</th><th>短剧VIP</th><th>用户名</th><th>余额</th><th>注册时间</th><th>最后登录时间</th><th>QQ</th><th>某种神秘代码</th><th>状态</th><th>操作</th></tr></thead>
          <tbody>
<?php
$pagesize=30;
