...
<div class="block-title"><h3 class="panel-title">网站其他配置①</h3><ul class="nav nav-tabs">
  <li class="active"><a href="#fenzhan_1001" data-toggle="tab" aria-expanded="true">会员中心相关</a></li>
  <li><a href="#fenzhan_1002" data-toggle="tab" aria-expanded="true">首页相关</a></li>
...
<form onsubmit="return saveSetting(this)" method="post" class="form-horizontal form-bordered" role="form">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">开启人工充值</label>
						<div class="col-sm-2"><select class="form-control" name="rgcz_car" default="<?php echo $conf['rgcz_car']; ?>">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">充值页面说明</label>
						<div class="col-sm-10"><textarea name="czsm1" style="width:100%;height:100px" /><?php echo $conf['czsm1']; ?></textarea><font color="green">html代码，随便在发布个新通知里编辑好然后复制HTML代码即可</font></div>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">购买订单页面说明</label>
						<div class="col-sm-10"><textarea name="czsm2" style="width:100%;height:100px" /><?php echo $conf['czsm2']; ?></textarea><font color="green">html代码，随便在发布个新通知里编辑好然后复制HTML代码即可</font></div>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">开通站点页面说明</label>
						<div class="col-sm-10"><textarea name="czsm3" style="width:100%;height:100px" /><?php echo $conf['czsm3']; ?></textarea><font color="green">html代码，随便在发布个新通知里编辑好然后复制HTML代码即可</font></div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10"><textarea name="wywz01" style="width:100%;height:75px" /><?php echo $conf['wywz01']; ?></textarea><font color="green"></font></div>
					</div>
...
<form onsubmit="return saveSetting(this)" method="post" class="form-horizontal form-bordered" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-2"><select class="form-control" name="syggw_car" default="<?php echo $conf['syggw_car']; ?>">
						<option value="0">关闭</option>
						<option value="1">开启</option>
						</select></div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2"><select class="form-control" name="xwgg_car" default="<?php echo $conf['xwgg_car']; ?>">
						<option value="0">关闭</option>
						<option value="1">开启</option>
						</select></div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">开启首页公告2</label>
						<div class="col-sm-2"><select class="form-control" name="xwgg2_car" default="<?php echo $conf['xwgg2_car']; ?>">
						<option value="0">关闭</option>
						<option value="1">开启</option>
						</select></div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">公告文字介绍2</label>
						<div class="col-sm-10"><textarea name="xwgg2" style="width:100%;height:75px" /><?php echo $conf['xwgg2']; ?></textarea><font color="green">html代码，随便在发布个新通知里编辑好然后复制HTML代码即可</font></div>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">存储文字（无用）</label>
						<div class="col-sm-10"><textarea name="wywz02" style="width:100%;height:75px" /><?php echo $conf['wywz02']; ?></textarea><font color="green"></font></div>
					</div>
...
<form onsubmit="return saveSetting(this)" method="post" class="form-horizontal form-bordered" role="form">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">商品详情-业务说明</label>
						<div class="col-sm-10"><textarea name="ywsm1" style="width:100%;height:200px" /><?php echo $conf['ywsm1']; ?></textarea><font color="green">html代码，随便在发布个新通知里编辑好然后复制HTML代码即可</font></div>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">是否开启商品销量展示</label>
						<div class="col-sm-2"><select class="form-control" name="spzs_sales" default="<?php echo $conf['spzs_sales']; ?>">
						<option value="0">关闭</option>
						<option value="1">开启</option>
						</select></div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2"><select class="form-control" name="spzs_car" default="<?php echo $conf['spzs_car']; ?>">
						<option value="0">关闭</option>
						<option value="1">开启</option>
						</select></div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">存储文字（无用）</label>
						<div class="col-sm-10"><textarea name="wywz03" style="width:100%;height:75px" /><?php echo $conf['wywz03']; ?></textarea><font color="green"></font></div>
					</div>
...
<form onsubmit="return saveSetting(this)" method="post" class="form-horizontal form-bordered" role="form">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">是否开启充值余额提现</label>
						<div class="col-sm-2"><select class="form-control" name="ccczye_tixian" default="<?php echo $conf['ccczye_tixian']; ?>">
						<option value="0">关闭</option>
						<option value="1">开启</option>
						</select></div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">永久地址①</label>
						<div class="col-sm-10"><input type="text" name="cos02" value="<?php echo $conf['cos02']; ?>" class="form-control"/><font color="green">填网址即可，如：https://link3.cc/cy01</font></div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">存储文字（无用）</label>
						<div class="col-sm-10"><textarea name="wywz04" style="width:100%;height:75px" /><?php echo $conf['wywz04']; ?></textarea><font color="green"></font></div>
					</div>
