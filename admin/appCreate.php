...
<form onsubmit="return saveSetting(this)" method="post" class="form-horizontal form-bordered" role="form">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-9"><select class="form-control" name="appcreate_theme" default="<?php echo $conf['appcreate_theme']?>"><option value="#00A7AA">绿色</option><option value="#FFB6C1">浅粉丝</option><option value="#00BFFF">深蓝色</option><option value="#FF4500">橙红色</option><option value="#4169E1">皇家蓝</option><option value="#ffa56a">配套橙</option></select></div>
	</div>
	<div class="form-group">
