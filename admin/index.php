...
<div class="col-xs-4 col-lg-2 showcountr">
	...
	<div class="widget-content widget-content-mini text-right clearfix">
		<h2 class="widget-heading h5 text-warning" style="color:#777777">
...
<div class="col-xs-4 col-lg-2 showcountr">
	...
	<div class="widget-content widget-content-mini text-right clearfix">
		<h2 class="widget-heading h5 text-success" style="color:#777777">
...
<div class="col-sm-4 col-lg-6">
	<div class="widget">
		<div class="widget-content border-bottom">
<i class="fa fa-angle-double-right"></i> 待处理统计
		</div>
<table class="table table-bordered">
	<tbody>
		<tr>
			<td style="font-size: 13px;" class="text-center">
				待处理工单<br><center><a id="count17" href="workorder.php">0</a>个</center>
			</td>
			<td style="font-size: 13px;" class="text-center">
				待处理提现<br><center><a id="count11" href="tixian.php">0</a>元</center></h5>
			</td>
			<td style="font-size: 13px;" class="text-center">
		...
		<tr>
			<td style="font-size: 13px;" class="text-center">
				待处理订单<br><center><a id="count3" href="./list.php?type=0">0</a>个</center></h5>
			</td>
			<td style="font-size: 13px;" class="text-center">
				正在处理订单<br><a id="count77" href="./list.php?type=2">0</a>个</center></h5>
			</td>
			<td style="font-size: 13px;" class="text-center">
				异常订单<br><a id="count78" href="./list.php?type=3">0</a>个</center></h5>
			</td>
		</tr>
	</tbody>
</table>
...
<div class="col-sm-4 col-lg-6">
	<div class="widget">
		<div class="widget-content border-bottom">
<i class="fa fa-angle-double-right"></i> 充值统计 <span style="color: #666666;font-size: 12px;">今天:<span id="count5" >0</span> | 昨天:<span id="count18">0</span> | 30天:<span id="count97">0</span></span>
		</div>
		<div class="widget-content widget-content-full">
			<div class="row text-center">
...
$(document).ready(function(){
	...
	$.ajax({
		...
		success : function(data) {
			...
			$('#count77').html(data.count77);
			$('#count78').html(data.count78);
