...
$("#add_submit").click(function () {
   ...
   $("#cid").change(function () {
       ...
       $("#shoplist").empty();
       // 添加一列用于显示商品是否已添加的状态
       $("#shoplist").append('<tr><td><label class="csscheckbox csscheckbox-primary">全选<input type="checkbox" onclick="SelectAll(this)"><span></span></label>&nbsp;ID</td><td>商品名称</td><td>成本价</td><td>状态</td><td>是否已添加</td></tr>');
       $.ajax({
           type : "POST",
