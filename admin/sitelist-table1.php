...
?>
	  <div class="table-responsive">
        <table class="table table-striped">
          ...
          <thead><tr><th>分站ID</th><th>上级ID</th><th>站长级别</th><th>短剧VIP</th><th>用户名</th><th>站点名称/站长QQ</th><th>余额</th><th>开通/到期时间</th><th>最后登录时间</th><th>绑定域名</th><th>某种神秘代码</th><th>状态</th><th>操作</th></tr></thead>
          <tbody>
<?php
$pagesize=30;
